...
#define ADDARRAY(arg) do { \
	...
	{ static char const label[] = { r,a,m,f,l,a,g, NUL }; ADD(mem.ramflag); }
	{ static char const label[] = { s,g,b,s,y,t,m, NUL }; ADDPTR(mem.sgb.systemTilemap); }
	{ static char const label[] = { s,g,b,t,i,l,m, NUL }; ADDPTR(mem.sgb.tilemap); }
	{ static char const label[] = { s,g,b,s,y,t,c, NUL }; ADDPTR(mem.sgb.systemTileColors); }
	{ static char const label[] = { s,g,b,t,i,l,c, NUL }; ADDPTR(mem.sgb.tileColors); }
	{ static char const label[] = { s,g,b,s,y,c,o, NUL }; ADDPTR(mem.sgb.systemColors); }
	{ static char const label[] = { s,g,b,c,o,l,s, NUL }; ADDPTR(mem.sgb.colors); }
	{ static char const label[] = { s,g,b,s,y,a,t, NUL }; ADDPTR(mem.sgb.systemAttributes); }
	{ static char const label[] = { s,g,b,a,t,t,r, NUL }; ADDPTR(mem.sgb.attributes); }
	{ static char const label[] = { s,g,b,s,y,t,i, NUL }; ADDPTR(mem.sgb.systemTiles); }
	{ static char const label[] = { s,g,b,t,i,l,s, NUL }; ADDPTR(mem.sgb.tiles); }
	...
	{ static char const label[] = { s,g,b,b,o,f,d, NUL }; ADD(mem.sgb.borderFade); }
	...
	{ static char const label[] = { c,a,m,v,h,     NUL }; ADD(camera.vh); }
	...
	{ static char const label[] = { c,a,m,o,n,     NUL }; ADD(camera.oldN); }
	{ static char const label[] = { c,a,m,o,v,h,   NUL }; ADD(camera.oldVh); }
